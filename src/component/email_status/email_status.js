...
//     'div[style*="border-left: 6px solid #007bff"][style*="linear-gradient(145deg, #ffffff, #f0f8ff)"]'
//   );
//   if(pendingAlert){
//     console.log("fonud the pending alert")
//     console.lo("pending popup is found")
//     return;
//   }
//   console.log("Not found the pending Alert")
...
export function showAlert(key, messageReason = " ") {
  ...
  if (key === "pending") {
    ...
    if (pendingAlert) {
      console.log("Found the pending alert");
      return;
    }
  }
  console.log("Not found the pending Alert");
