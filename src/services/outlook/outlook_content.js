...
/**
 * Retrieves the "registration" data from browser's local storage.
...
/**
 * Listens for messages sent from other parts of the browser extension.
 *
 ...
 *
 * Once found, the email ID is extracted, decoded, and stored in browser's local storage under
